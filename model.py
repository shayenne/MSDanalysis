...
def basic_info(categories=["tempo","duration","key","time_signature","song_hotttnesss"],saved_csv=None):
    ...
    if saved_csv: 
        ...
        df = get_song_data(categories,write=True, write_path="./temp/song_data1.csv")
...
def error_bar(categories=["segments_loudness_max","segments_confidence"],data_i=[0,1],sec_i=[0,100],saved_csv=None):
